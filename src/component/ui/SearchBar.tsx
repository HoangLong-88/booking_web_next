        ...
        <div className="absolute left-1/2 -translate-x-1/2 bottom-[-40px] z-20 w-[92%] md:w-[85%] max-w-6xl">
          <form className="bg-white rounded-xl shadow-2xl ring-1 ring-black/5 p-3 flex gap-3 items-center border-2 border-orange-300">
            <div className="flex-1 flex items-center gap-3">
              <div className="flex items-center gap-3 px-4 py-3 rounded-lg border border-transparent hover:border-gray-200 w-72 bg-white">
              ...
              <div className="flex items-center gap-3 px-4 py-3 rounded-lg border border-transparent hover:border-gray-200 bg-white">
                ...
                <input className="w-48 text-sm outline-none" placeholder="Check in date — Check out date" />
              </div>
              ...
              <div className="flex items-center gap-3 px-4 py-3 rounded-lg border border-transparent hover:border-gray-200 bg-white">
                ...
                <input className="w-48 text-sm outline-none" placeholder="2 người lớn · 0 trẻ em · 1 phòng" />
              </div>
            </div>
